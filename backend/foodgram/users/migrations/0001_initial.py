# Generated by Django 4.2.3 on 2023-07-30 08:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(max_length=254, unique=True, verbose_name='Почта пользователя')),
                ('username', models.CharField(max_length=150, unique=True, validators=[users.validators.validate_username], verbose_name='Юзернейма пользователя')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Доступ пользователя')),
